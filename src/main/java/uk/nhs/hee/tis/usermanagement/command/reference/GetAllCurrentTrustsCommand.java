...
public class GetAllCurrentTrustsCommand extends ReferenceHystrixCommand<List<TrustDTO>> {
  ...
  public GetAllCurrentTrustsCommand(RestTemplate referenceRestTemplate, String serviceUrl, int page, int size) {
  ...
  protected List<TrustDTO> getFallback() {
    LOG.warn("An error occurred while getting all Current Trusts from the Reference service. Returning empty List");
